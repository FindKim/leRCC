...
file_out = open('/afs/crc.nd.edu/user/k/kngo/leRCC/results/avg_seq_length_t_test/median_seq_length.txt', 'w') # overwrites if exits

file_out.write('Calculated median seq length for significant and non-significant sequences differing by p-Value cut offs.')
file_out.write('\n')
file_out.write('\n')
