...
os.system("ps2pdf sig_pruned_masked_p.0001_rcclust_sum.ps sig_pruned_masked_p.0001_rcclust_sum.pdf")

os.system("sed -i 's/_p\.0001/_p\.001/g' plot_rcclust_sum.gp")
os.system("sed -i 's/p-Value .*\"/p-Value \.001\"/g' plot_rcclust_sum.gp")
os.system("gnuplot plot_rcclust_sum.gp")
os.system("ps2pdf sig_pruned_masked_p.001_rcclust_sum.ps sig_pruned_masked_p.001_rcclust_sum.pdf")

os.system("sed -i 's/_p\.001/_p\.01/g' plot_rcclust_sum.gp")
os.system("sed -i 's/p-Value .*\"/p-Value \.01\"/g' plot_rcclust_sum.gp")
os.system("gnuplot plot_rcclust_sum.gp")
os.system("ps2pdf sig_pruned_masked_p.01_rcclust_sum.ps sig_pruned_masked_p.01_rcclust_sum.pdf")

os.system("sed -i 's/_p\.01/_p\.05/g' plot_rcclust_sum.gp")
os.system("sed -i 's/p-Value .*\"/p-Value \.05\"/g' plot_rcclust_sum.gp")
os.system("gnuplot plot_rcclust_sum.gp")
os.system("ps2pdf sig_pruned_masked_p.05_rcclust_sum.ps sig_pruned_masked_p.05_rcclust_sum.pdf")
